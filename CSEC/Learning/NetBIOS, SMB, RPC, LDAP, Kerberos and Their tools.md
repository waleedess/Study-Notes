...
| U: 53  | DNS SRV records             | Discover _where_ the KDC servers actually live on the network. | - Before a client can send a packet to port 88, it uses DNS SRV records (`_kerberos._udp.domain.com`) to discover<br><br>-                                                                                                                                                                                                                                                                                                                                          |
